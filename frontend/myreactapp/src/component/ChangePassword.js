...
//
  ...
  const changepass =() =>{
    ...
    .then((res)=> setServerRes(res.data.status))
    ...
    return (
        <form style={{
            ...
            <div class="form-outline mb-4">
                ...
                <input type="password" name="new_pass" value={loginData.newpassword} onChange={handleChange} id="newpassword" class="form-control" />
            </div>
            ...
            {/* <!-- Submit button --> */}
            <button type="button" onClick={changepass} class="btn btn-primary btn-block mb-4">
                ChangePassword
            </button>

            {serverRes && <Message message="Password changed successfully" />}
